...
def getEncodedStr():
    client_id = "23B78C"        # ADD YOUR OWN CLIENT ID USING FITBIT API INSIDE THE "" specified !
    client_secret = "088073ff558bab2bf55e011cbb997b82"    # ADD YOUR OWN CLIENT SECRET KEY USING FITBIT API INSIDE THE "" specified !
